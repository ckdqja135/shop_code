...
<%
 ...
 try{
  con = DriverManager.getConnection("jdbc:mysql://localhost:3306/shop?useUnicode=true&characterEncoding=utf8","root","1234");
 ...
 try {
  ...
  if (!(rs.next()))  {
   ...
   out.println("<IMG width=200 height=200 src="+small+">");
