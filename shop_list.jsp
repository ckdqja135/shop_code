 ...
 <TR>
  <TH>
   <FONT size=-1>
    ...
    <A href="shop_list.jsp?cat=11">FPS</A>-
    <A href="shop_list.jsp?cat=22">격투</A>-
    <A href="shop_list.jsp?cat=33">공포</A>-
    <A href="shop_list.jsp?cat=44">미스테리</A>-
    <A href="shop_list.jsp?cat=55">생존</A>-
    <A href="shop_list.jsp?cat=66">스토리텔링</A>-
    <A href="shop_list.jsp?cat=77">스포츠</A>-
    <A href="shop_list.jsp?cat=88">액션</A>-
    <A href="shop_list.jsp?cat=99">전략</A>
   </FONT>
  </TH>
 </TR>
</TABLE>
 ...
 try {
  ...
  if (!(rs.next()))  
   ...
   for(int j=startrow;j<=endrow;j++) { 
    ...
    out.println("<IMG border=0 width=100 height=100 src=\""+filename+"\">");
    out.println("<BR></A></TH>");
    ...
    out.println("</TD></TR>"); 
    out.println("<FORM method=post name=search action=\"sale.jsp?stock="+stocki+"\">");
	out.println("<TR>");
